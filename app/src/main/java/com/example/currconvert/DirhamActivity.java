...
public class DirhamActivity extends AppCompatActivity {

    public void Dirhamconvert(View view)
    {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dirham);
    }
}
